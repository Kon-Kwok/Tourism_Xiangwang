...
CREATE TABLE `gravity_rubiks_cube` (
  ...
  `cost` decimal(14,2) DEFAULT NULL COMMENT 'Cost 花费',
  ...
  `sales` decimal(14,2) DEFAULT NULL COMMENT 'Sales 销量',
  ...
  `ctr` decimal(10,6) DEFAULT NULL COMMENT 'CTR 点击率',
  `cpc` decimal(10,2) DEFAULT NULL COMMENT 'CPC 点击成本',
  `cpm` decimal(10,2) DEFAULT NULL COMMENT 'CPM 拉新成本',
  `roi` decimal(10,4) DEFAULT NULL COMMENT 'ROI 投资回报率',
  `cvr` decimal(10,6) DEFAULT NULL COMMENT 'CVR 点击转化率',
  `collection_cart_cost` decimal(14,2) DEFAULT NULL COMMENT '收藏加购成本',
  `collection_cart_count` bigint DEFAULT NULL COMMENT '收藏加购量',
  `collection_cart_rate` decimal(10,6) DEFAULT NULL COMMENT '收藏加购率',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_date_time` (`date_time`)
...
CREATE TABLE `star_store` (
  ...
  `ctr` decimal(10,6) DEFAULT NULL COMMENT 'CTR 点击率',
  `cpc` decimal(10,2) DEFAULT NULL COMMENT 'CPC 点击成本',
  `cpm` decimal(14,2) DEFAULT NULL COMMENT 'CPM 千次展现成本',
  `roi` decimal(10,4) DEFAULT NULL COMMENT 'ROI 投资回报率',
  `cvr` decimal(10,6) DEFAULT NULL COMMENT 'CVR 点击转化率',
  `asp` decimal(14,2) DEFAULT NULL COMMENT 'ASP 订单均价',
  `cporder` decimal(14,2) DEFAULT NULL COMMENT 'Cporder 订单成本',
  `cpshopping_cart` decimal(14,2) DEFAULT NULL COMMENT 'CPshopping cart 加购成本',
  `cart_rate` decimal(10,6) DEFAULT NULL COMMENT '加购率',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_date_time` (`date_time`)
...
CREATE TABLE `tmall_express` (
  ...
  `click` bigint DEFAULT NULL COMMENT 'Click 点击',
  `order_count` bigint DEFAULT NULL COMMENT 'Order 订单',
  `sales` decimal(14,2) DEFAULT NULL COMMENT 'Sales 销量GMV',
  `shopping_cart` bigint DEFAULT NULL COMMENT 'ShoppingCart 加入购物车',
  `bookmark_product` bigint DEFAULT NULL COMMENT 'Bookmark-Product 宝贝收藏',
  `bookmark_store` bigint DEFAULT NULL COMMENT 'Bookmark-Store 店铺收藏',
  `ctr` decimal(10,6) DEFAULT NULL COMMENT 'CTR 点击率',
...
CREATE TABLE `wanxiangtai_2` (
  ...
  `ctr` decimal(10,6) DEFAULT NULL COMMENT 'CTR 点击率',
  `cpc` decimal(10,2) DEFAULT NULL COMMENT 'CPC 点击成本',
  `cpm` decimal(10,2) DEFAULT NULL COMMENT 'CPM 拉新成本（千次曝光）',
  `roi` decimal(10,4) DEFAULT NULL COMMENT 'ROI 投资回报率',
  `cvr` decimal(10,6) DEFAULT NULL COMMENT 'CVR 点击转化率',
  `collection_cart_cost` decimal(14,2) DEFAULT NULL COMMENT '收藏加购成本',
  `collection_cart_count` int DEFAULT NULL COMMENT '收藏加购数',
